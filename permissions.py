...
PERMISSION_CATALOG = [
    ...
    {"key": "module.mailing", "label": "Mailing", "group": "Modüller",
     "desc": "Kampanya, Mail Rehber, şablon ve IVR mailing modülü"},
    ...
    {"key": "tracking.smartico", "label": "Smartico Affiliate / Üye Taşıma", "group": "Link Takip",
     "desc": "Smartico rapor, int-api üye taşıma (affiliate değiştirme) ve ayarlar"},
    ...
    {"key": "mailing.crm", "label": "Mail Rehber", "group": "Mailing",
     "desc": "Kontak listesi, etiket ve CSV import"},
    {"key": "mailing.relations", "label": "CRM (İlişki)", "group": "Mailing",
     "desc": "Yaşam döngüsü, skor, not, görev ve etkileşim zaman çizelgesi"},
